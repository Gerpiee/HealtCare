...
const NarcoticsDailySalesReports = () => {
  ...
  const columns = [
    ...
    { field: "medicanename", headerName: "Medicane Name", width: 200 },
    {
      field: "patient",
      headerName: "Patient",
      width: 100,
  ...
  return (
    <div style={{ marginTop: "4%" }}>
      ...
      <Typography sx={{ marginTop: "1%" }}>
        Narcotics Daily Sales Summary Report
      </Typography>
      <Box>
        ...
        <Grid container spacing={2}>
          <Grid item xs={1.4}>
            <InputLabel style={{ marginTop: "15%" }}>Select Item:</InputLabel>
          </Grid>
...
export default NarcoticsDailySalesReports;
